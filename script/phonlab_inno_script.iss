...
AppId={{209301C6-24DC-45D5-8DAC-CC33C639AEE4}
AppName={#MyAppName}
...
OutputBaseFilename=Phonlab Installer
...
Source: {#MySourceDirPath}; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
