...
class AnnotationViewModel(ViewModel):
    ...
    def change_node_state(self, drag_node: int, new_pos: float):
        start, end = self.annotation_window_state.start, self.annotation_window_state.end
        ...
        self.annotation_window_state = replace(self.annotation_window_state, annotation_state=annotation_state)
